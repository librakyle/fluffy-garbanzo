...
var ancient = {
    "3": {
        "Name": "智慧神器(Solomon),+%远古Boss掉落的英魂数量",
        "Level": Decimal(0),
    ...
    "21": {
        "Name": "暗影神器(Kumawakamaru),减少每层需要杀怪数",
        "Level": Decimal(0),
        "OptimalLevel": Decimal(0),
        "CostToOptimal": Decimal(0),
        "Visible": "true",
